...
COMMON_COFFEE_FIREFOX_TARGET_FILES = $(patsubst src/common/coffee/%.coffee, build/firefox/data/js/%.js, $(COMMON_COFFEE_FILES))
FIREFOX_COFFEE_TARGET_FILES = $(patsubst src/firefox/coffee/%.coffee, build/firefox/data/js/%.js, $(FIREFOX_COFFEE_FILES)) $(COMMON_COFFEE_FIREFOX_TARGET_FILES)
...
FIREFOX_DIRS = build/firefox/.dirstamp build/firefox/data/.dirstamp $(patsubst target/%,build/firefox/data/%/.dirstamp, $(SUB_DIRS)) build/
...
firefox_html: dirs $(patsubst src/common/%, build/firefox/data/%, $(COMMON_HTML_FILES)) $(patsubst src/%, build/%, $(FIREFOX_HTML_FILES))

chrome_libs: dirs $(patsubst src/common/%, build/chrome/%, $(COMMON_LIBS_FILES)) $(patsubst src/%, build/%, $(CHROME_LIBS_FILES))
firefox_libs: dirs $(patsubst src/common/%, build/firefox/data/%, $(COMMON_LIBS_FILES)) $(patsubst src/%, build/%, $(FIREFOX_LIBS_FILES))

chrome_images: dirs $(patsubst src/common/%, build/chrome/%, $(COMMON_IMAGE_FILES)) $(patsubst src/%, build/%, $(CHROME_IMAGE_FILES))
firefox_images: dirs $(patsubst src/common/%, build/firefox/data/%, $(COMMON_IMAGE_FILES)) $(patsubst src/%, build/%, $(FIREFOX_IMAGE_FILES))

chrome_data: dirs $(patsubst src/common/%, build/chrome/%, $(COMMON_DATA_FILES)) $(patsubst src/%, build/%, $(CHROME_DATA_FILES))
firefox_data: dirs $(patsubst src/common/%, build/firefox/data/%, $(COMMON_DATA_FILES)) $(patsubst src/%, build/%, $(FIREFOX_DATA_FILES))
